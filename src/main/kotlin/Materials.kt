...
val materials = listOf(
        ...
        Material(name = "TPU", extruderTemp = 200, bedTemp = 60, extrusionMultiplier = 1.25, defaultPrintingSpeed = 30, firstLayerHeightPercentage = 200, firstLayerWidthPercentage = 100),
